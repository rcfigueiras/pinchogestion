...
class PostMapper {
  ...
  public function findAll() {   
    $stmt = $this->db->query("SELECT id_administrador, nombre_consurso, bases FROM PINCHOGES ");    
    ...
    foreach ($posts_db as $post) {
      ...
      array_push($posts, new Post($post["id_administrador"], $post["nombre_consurso"], $post["bases"], $author));
    }   
  ...
  public function findById($postid){
    $stmt = $this->db->prepare("SELECT * FROM PINCHOGES WHERE id_administrador=?");
