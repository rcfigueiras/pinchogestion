...
if ($accion=="Loguear" )
{
   ...
   // $sql = "select * from ADMINISTRADOR where nombre_admin = '".$login."'";
    $sql = "select * from ADMINISTRADOR,ESTABLECIMIENTO,JURADO_POPULAR,JURADO_PROFESIONAL where nombre_estab = '".$login."' 
																							OR nombre_admin = '".$login."'";
    ...
    if (mysql_num_rows($resultado) == 1)
    {
        ...
        if ($pass==$res['contrasenha_estab']){
            ...
            $_SESSION['ID_administrador']=$res['ID_administrador'];
